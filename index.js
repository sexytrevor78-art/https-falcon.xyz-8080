...
const manifest = {
  ...
  catalogs: [
    ...
    {
      type: "movie",
      id: "falcon-best-picture",
      name: "Falcon – Best Picture Winners",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "series",
      id: "falcon-award-drama",
      name: "Falcon – Award-Winning Drama",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-scifi",
      name: "Falcon – Sci-Fi & Space",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-action-thriller",
      name: "Falcon – Action & Thriller",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-animated-family",
      name: "Falcon – Animated & Family",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-romance",
      name: "Falcon – Romance & Rom-Coms",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-crime-gangster",
      name: "Falcon – Crime & Gangster",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
    ...
    },
    {
      type: "movie",
      id: "falcon-superhero",
      name: "Falcon – Superhero",
      extra: [{ name: "skip", isRequired: false }]
    },
    {
      type: "movie",
      id: "falcon-documentaries",
      name: "Falcon – Documentaries",
      extra: [{ name: "skip", isRequired: false }]
    }
  ],
...
const bestPictureWinners = [
  { id: "tt0068646", name: "The Godfather", year: 1972, poster: "https://images.metahub.space/poster/medium/tt0068646/img" },
  { id: "tt0071562", name: "The Godfather Part II", year: 1974, poster: "https://images.metahub.space/poster/medium/tt0071562/img" },
  { id: "tt0075148", name: "Rocky", year: 1976, poster: "https://images.metahub.space/poster/medium/tt0075148/img" },
  { id: "tt0077416", name: "Annie Hall", year: 1977, poster: "https://images.metahub.space/poster/medium/tt0077416/img" },
  { id: "tt0079522", name: "Kramer vs. Kramer", year: 1979, poster: "https://images.metahub.space/poster/medium/tt0079522/img" },
  { id: "tt0080678", name: "Ordinary People", year: 1980, poster: "https://images.metahub.space/poster/medium/tt0080678/img" },
  { id: "tt0082971", name: "Raiders of the Lost Ark", year: 1981, poster: "https://images.metahub.space/poster/medium/tt0082971/img" },
  { id: "tt0083987", name: "Gandhi", year: 1982, poster: "https://images.metahub.space/poster/medium/tt0083987/img" },
  { id: "tt0087332", name: "Amadeus", year: 1984, poster: "https://images.metahub.space/poster/medium/tt0086879/img" },
  { id: "tt0091763", name: "Platoon", year: 1986, poster: "https://images.metahub.space/poster/medium/tt0091763/img" },
  { id: "tt0094226", name: "The Last Emperor", year: 1987, poster: "https://images.metahub.space/poster/medium/tt0094226/img" },
  { id: "tt0097576", name: "Driving Miss Daisy", year: 1989, poster: "https://images.metahub.space/poster/medium/tt0097576/img" },
  { id: "tt0099348", name: "Dances with Wolves", year: 1990, poster: "https://images.metahub.space/poster/medium/tt0099348/img" },
  { id: "tt0102926", name: "The Silence of the Lambs", year: 1991, poster: "https://images.metahub.space/poster/medium/tt0101414/img" },
  { id: "tt0105695", name: "Unforgiven", year: 1992, poster: "https://images.metahub.space/poster/medium/tt0105695/img" },
  { id: "tt0108052", name: "Schindler's List", year: 1993, poster: "https://images.metahub.space/poster/medium/tt0108052/img" },
  { id: "tt0109830", name: "Forrest Gump", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0109830/img" },
  { id: "tt0112573", name: "Braveheart", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0112573/img" },
  { id: "tt0116282", name: "The English Patient", year: 1996, poster: "https://images.metahub.space/poster/medium/tt0116282/img" },
  { id: "tt0120338", name: "Titanic", year: 1997, poster: "https://images.metahub.space/poster/medium/tt0120338/img" },
  { id: "tt0120815", name: "Shakespeare in Love", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0138097/img" },
  { id: "tt0169547", name: "American Beauty", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0169547/img" },
  { id: "tt0172495", name: "Gladiator", year: 2000, poster: "https://images.metahub.space/poster/medium/tt0172495/img" },
  { id: "tt0268978", name: "A Beautiful Mind", year: 2001, poster: "https://images.metahub.space/poster/medium/tt0268978/img" },
  { id: "tt0216701", name: "Chicago", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0299658/img" },
  { id: "tt0167260", name: "The Lord of the Rings: The Return of the King", year: 2003, poster: "https://images.metahub.space/poster/medium/tt0167260/img" },
  { id: "tt0371746", name: "Million Dollar Baby", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0380510/img" },
  { id: "tt0375679", name: "Crash", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0375679/img" },
  { id: "tt0407887", name: "The Departed", year: 2006, poster: "https://images.metahub.space/poster/medium/tt0407887/img" },
  { id: "tt0477348", name: "No Country for Old Men", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0477348/img" },
  { id: "tt1010048", name: "Slumdog Millionaire", year: 2008, poster: "https://images.metahub.space/poster/medium/tt1010048/img" },
  { id: "tt0887912", name: "The Hurt Locker", year: 2009, poster: "https://images.metahub.space/poster/medium/tt0887912/img" },
  { id: "tt1504320", name: "The King's Speech", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1504320/img" },
  { id: "tt1588392", name: "The Artist", year: 2011, poster: "https://images.metahub.space/poster/medium/tt1588392/img" },
  { id: "tt1824220", name: "Argo", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1824220/img" },
  { id: "tt2024544", name: "12 Years a Slave", year: 2013, poster: "https://images.metahub.space/poster/medium/tt2024544/img" },
  { id: "tt2562232", name: "Birdman", year: 2014, poster: "https://images.metahub.space/poster/medium/tt2562232/img" },
  { id: "tt1663202", name: "The Revenant", year: 2015, poster: "https://images.metahub.space/poster/medium/tt1663202/img" },
  { id: "tt4975722", name: "Moonlight", year: 2016, poster: "https://images.metahub.space/poster/medium/tt4975722/img" },
  { id: "tt5580390", name: "The Shape of Water", year: 2017, poster: "https://images.metahub.space/poster/medium/tt5580390/img" },
  { id: "tt6751668", name: "Green Book", year: 2018, poster: "https://images.metahub.space/poster/medium/tt6751668/img" },
  { id: "tt6966692", name: "Parasite", year: 2019, poster: "https://images.metahub.space/poster/medium/tt6966692/img" },
  { id: "tt10272386", name: "Nomadland", year: 2020, poster: "https://images.metahub.space/poster/medium/tt10272386/img" },
  { id: "tt1745960", name: "CODA", year: 2021, poster: "https://images.metahub.space/poster/medium/tt10366460/img" },
  { id: "tt1160419", name: "Everything Everywhere All at Once", year: 2022, poster: "https://images.metahub.space/poster/medium/tt6710474/img" },
  { id: "tt15398776", name: "Oppenheimer", year: 2023, poster: "https://images.metahub.space/poster/medium/tt15398776/img" }
];

const awardDramaSeries = [
  { id: "tt0141842", name: "The Sopranos", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0141842/img" },
  { id: "tt0306414", name: "The Wire", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0306414/img" },
  { id: "tt0903747", name: "Breaking Bad", year: 2008, poster: "https://images.metahub.space/poster/medium/tt0903747/img" },
  { id: "tt0944947", name: "Game of Thrones", year: 2011, poster: "https://images.metahub.space/poster/medium/tt0944947/img" },
...
const sciFi = [
  { id: "tt0076759", name: "Star Wars: A New Hope", year: 1977, poster: "https://images.metahub.space/poster/medium/tt0076759/img" },
  { id: "tt0080684", name: "The Empire Strikes Back", year: 1980, poster: "https://images.metahub.space/poster/medium/tt0080684/img" },
  { id: "tt0083658", name: "Blade Runner", year: 1982, poster: "https://images.metahub.space/poster/medium/tt0083658/img" },
  { id: "tt0078788", name: "Close Encounters of the Third Kind", year: 1977, poster: "https://images.metahub.space/poster/medium/tt0078788/img" },
  { id: "tt0082971", name: "E.T. the Extra-Terrestrial", year: 1982, poster: "https://images.metahub.space/poster/medium/tt0082971/img" },
  { id: "tt0133093", name: "The Matrix", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0133093/img" },
  { id: "tt0114709", name: "2001: A Space Odyssey", year: 1968, poster: "https://images.metahub.space/poster/medium/tt0062622/img" },
  { id: "tt1375666", name: "Inception", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1375666/img" },
  { id: "tt0770828", name: "Man of Steel", year: 2013, poster: "https://images.metahub.space/poster/medium/tt0770828/img" },
  { id: "tt1454468", name: "Gravity", year: 2013, poster: "https://images.metahub.space/poster/medium/tt1454468/img" },
  { id: "tt0816692", name: "Interstellar", year: 2014, poster: "https://images.metahub.space/poster/medium/tt0816692/img" },
  { id: "tt1535109", name: "Ex Machina", year: 2014, poster: "https://images.metahub.space/poster/medium/tt1535109/img" },
  { id: "tt1392190", name: "Mad Max: Fury Road", year: 2015, poster: "https://images.metahub.space/poster/medium/tt1392190/img" },
  { id: "tt3659388", name: "The Martian", year: 2015, poster: "https://images.metahub.space/poster/medium/tt3659388/img" },
  { id: "tt2543164", name: "Arrival", year: 2016, poster: "https://images.metahub.space/poster/medium/tt2543164/img" },
  { id: "tt1856101", name: "Blade Runner 2049", year: 2017, poster: "https://images.metahub.space/poster/medium/tt1856101/img" },
  { id: "tt0425112", name: "District 9", year: 2009, poster: "https://images.metahub.space/poster/medium/tt1136608/img" },
  { id: "tt0093773", name: "Predator", year: 1987, poster: "https://images.metahub.space/poster/medium/tt0093773/img" },
  { id: "tt0078748", name: "Alien", year: 1979, poster: "https://images.metahub.space/poster/medium/tt0078748/img" },
  { id: "tt0090605", name: "Aliens", year: 1986, poster: "https://images.metahub.space/poster/medium/tt0090605/img" },
  { id: "tt0088763", name: "Back to the Future", year: 1985, poster: "https://images.metahub.space/poster/medium/tt0088763/img" },
  ...
  { id: "tt0209144", name: "Memento", year: 2000, poster: "https://images.metahub.space/poster/medium/tt0209144/img" },
  { id: "tt0434409", name: "V for Vendetta", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0434409/img" },
  { id: "tt0381681", name: "Children of Men", year: 2006, poster: "https://images.metahub.space/poster/medium/tt0381681/img" }
];

const actionThriller = [
  { id: "tt0095016", name: "Die Hard", year: 1988, poster: "https://images.metahub.space/poster/medium/tt0095016/img" },
  { id: "tt0086960", name: "Beverly Hills Cop", year: 1984, poster: "https://images.metahub.space/poster/medium/tt0086960/img" },
  { id: "tt0092099", name: "Top Gun", year: 1986, poster: "https://images.metahub.space/poster/medium/tt0092099/img" },
  { id: "tt0111257", name: "Speed", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0111257/img" },
  ...
  { id: "tt0114369", name: "Se7en", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0114369/img" },
  { id: "tt0120815", name: "Saving Private Ryan", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0120815/img" },
  { id: "tt0266543", name: "The Bourne Identity", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0258463/img" },
  { id: "tt0372183", name: "The Bourne Supremacy", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0372183/img" },
  { id: "tt0440963", name: "The Bourne Ultimatum", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0440963/img" },
  { id: "tt0317219", name: "Casino Royale", year: 2006, poster: "https://images.metahub.space/poster/medium/tt0381061/img" },
  { id: "tt0113277", name: "Heat", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0113277/img" },
  { id: "tt0110413", name: "Léon: The Professional", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0110413/img" },
  { id: "tt0120735", name: "Lock, Stock and Two Smoking Barrels", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0120735/img" },
  { id: "tt1285016", name: "The Town", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1285016/img" },
  { id: "tt1343092", name: "Taken", year: 2008, poster: "https://images.metahub.space/poster/medium/tt1343092/img" },
  { id: "tt0437086", name: "Transformers", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0418279/img" },
  { id: "tt1570728", name: "Mission: Impossible – Ghost Protocol", year: 2011, poster: "https://images.metahub.space/poster/medium/tt1229238/img" },
  { id: "tt2024544", name: "John Wick", year: 2014, poster: "https://images.metahub.space/poster/medium/tt2911666/img" },
  { id: "tt1798684", name: "Mad Max: Fury Road", year: 2015, poster: "https://images.metahub.space/poster/medium/tt1392190/img" },
  { id: "tt0268126", name: "Catch Me If You Can", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0264464/img" },
  { id: "tt0082971", name: "Raiders of the Lost Ark", year: 1981, poster: "https://images.metahub.space/poster/medium/tt0082971/img" },
  { id: "tt0266543", name: "Ocean's Eleven", year: 2001, poster: "https://images.metahub.space/poster/medium/tt0240772/img" },
  { id: "tt0093058", name: "Full Metal Jacket", year: 1987, poster: "https://images.metahub.space/poster/medium/tt0093058/img" }
];

const animatedFamily = [
  { id: "tt0114709", name: "Toy Story", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0114709/img" },
  { id: "tt0120363", name: "Toy Story 2", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0120363/img" },
  { id: "tt0435761", name: "Toy Story 3", year: 2010, poster: "https://images.metahub.space/poster/medium/tt0435761/img" },
  { id: "tt0382932", name: "Ratatouille", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0382932/img" },
  { id: "tt0317219", name: "Finding Nemo", year: 2003, poster: "https://images.metahub.space/poster/medium/tt0266543/img" },
  { id: "tt0266543", name: "Monsters, Inc.", year: 2001, poster: "https://images.metahub.space/poster/medium/tt0198781/img" },
  { id: "tt0449059", name: "WALL·E", year: 2008, poster: "https://images.metahub.space/poster/medium/tt0449059/img" },
  { id: "tt1049413", name: "Up", year: 2009, poster: "https://images.metahub.space/poster/medium/tt1049413/img" },
  { id: "tt1727824", name: "Brave", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1217209/img" },
  { id: "tt2096673", name: "Inside Out", year: 2015, poster: "https://images.metahub.space/poster/medium/tt2096673/img" },
  { id: "tt0245429", name: "Spirited Away", year: 2001, poster: "https://images.metahub.space/poster/medium/tt0245429/img" },
  { id: "tt0347149", name: "Howl's Moving Castle", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0347149/img" },
  { id: "tt0096283", name: "My Neighbor Totoro", year: 1988, poster: "https://images.metahub.space/poster/medium/tt0096283/img" },
  { id: "tt0110357", name: "The Lion King", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0110357/img" },
  { id: "tt0103639", name: "Aladdin", year: 1992, poster: "https://images.metahub.space/poster/medium/tt0103639/img" },
  { id: "tt0109830", name: "The Little Mermaid", year: 1989, poster: "https://images.metahub.space/poster/medium/tt0097757/img" },
  { id: "tt0120623", name: "A Bug's Life", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0120623/img" },
  { id: "tt0317219", name: "Shrek", year: 2001, poster: "https://images.metahub.space/poster/medium/tt0126029/img" },
  { id: "tt0298148", name: "Shrek 2", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0298148/img" },
  { id: "tt0765446", name: "Kung Fu Panda", year: 2008, poster: "https://images.metahub.space/poster/medium/tt0441773/img" },
  { id: "tt0120917", name: "The Iron Giant", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0129167/img" },
  { id: "tt0268380", name: "Ice Age", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0268380/img" },
  { id: "tt0120338", name: "Mulan", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0120762/img" },
  { id: "tt0435761", name: "The Incredibles", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0317705/img" },
  { id: "tt1045658", name: "Coraline", year: 2009, poster: "https://images.metahub.space/poster/medium/tt0327597/img" }
];

const romanceRomCom = [
  { id: "tt0108160", name: "Sleepless in Seattle", year: 1993, poster: "https://images.metahub.space/poster/medium/tt0108160/img" },
  { id: "tt0120338", name: "You've Got Mail", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0128853/img" },
  { id: "tt0119822", name: "My Best Friend's Wedding", year: 1997, poster: "https://images.metahub.space/poster/medium/tt0119822/img" },
  { id: "tt0116583", name: "Jerry Maguire", year: 1996, poster: "https://images.metahub.space/poster/medium/tt0116583/img" },
  { id: "tt0172493", name: "Notting Hill", year: 1999, poster: "https://images.metahub.space/poster/medium/tt0163978/img" },
  { id: "tt0318649", name: "Love Actually", year: 2003, poster: "https://images.metahub.space/poster/medium/tt0314331/img" },
  { id: "tt0381061", name: "Hitch", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0386588/img" },
  { id: "tt0454921", name: "The Proposal", year: 2009, poster: "https://images.metahub.space/poster/medium/tt1041829/img" },
  { id: "tt0266697", name: "Crazy, Stupid, Love.", year: 2011, poster: "https://images.metahub.space/poster/medium/tt1570728/img" },
  { id: "tt1798709", name: "Her", year: 2013, poster: "https://images.metahub.space/poster/medium/tt1798709/img" },
  { id: "tt0338013", name: "Eternal Sunshine of the Spotless Mind", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0338013/img" },
  { id: "tt0120338", name: "Titanic", year: 1997, poster: "https://images.metahub.space/poster/medium/tt0120338/img" },
  { id: "tt0119217", name: "Good Will Hunting", year: 1997, poster: "https://images.metahub.space/poster/medium/tt0119217/img" },
  { id: "tt0109830", name: "Forrest Gump", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0109830/img" },
  { id: "tt0094721", name: "When Harry Met Sally...", year: 1989, poster: "https://images.metahub.space/poster/medium/tt0098258/img" },
  { id: "tt0107048", name: "Groundhog Day", year: 1993, poster: "https://images.metahub.space/poster/medium/tt0107048/img" },
  { id: "tt0240772", name: "Pretty Woman", year: 1990, poster: "https://images.metahub.space/poster/medium/tt0100405/img" },
  { id: "tt0102494", name: "Four Weddings and a Funeral", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0109831/img" },
  { id: "tt0266543", name: "The Notebook", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0332280/img" },
  { id: "tt0493464", name: "Atonement", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0783233/img" },
  { id: "tt1605783", name: "La La Land", year: 2016, poster: "https://images.metahub.space/poster/medium/tt3783958/img" },
  { id: "tt5013056", name: "Call Me by Your Name", year: 2017, poster: "https://images.metahub.space/poster/medium/tt5013056/img" },
  { id: "tt2948356", name: "The Big Sick", year: 2017, poster: "https://images.metahub.space/poster/medium/tt5607976/img" },
  { id: "tt7131622", name: "Crazy Rich Asians", year: 2018, poster: "https://images.metahub.space/poster/medium/tt3104988/img" },
  { id: "tt6751668", name: "About Time", year: 2013, poster: "https://images.metahub.space/poster/medium/tt2194499/img" }
];
...
const crimeGangster = [
  ...
  { id: "tt0266697", name: "Kill Bill: Volume 1", year: 2003, poster: "https://images.metahub.space/poster/medium/tt0266697/img" },
  { id: "tt0120735", name: "Lock, Stock and Two Smoking Barrels", year: 1998, poster: "https://images.metahub.space/poster/medium/tt0120735/img" },
  { id: "tt0187078", name: "Snatch", year: 2000, poster: "https://images.metahub.space/poster/medium/tt0208092/img" },
  { id: "tt0113277", name: "Heat", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0113277/img" },
  { id: "tt0110413", name: "Léon: The Professional", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0110413/img" },
  { id: "tt0264464", name: "Catch Me If You Can", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0264464/img" },
  { id: "tt0317248", name: "City of God", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0317248/img" },
  { id: "tt0477348", name: "No Country for Old Men", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0477348/img" },
  { id: "tt1305806", name: "The Secret in Their Eyes", year: 2009, poster: "https://images.metahub.space/poster/medium/tt1305806/img" },
  { id: "tt1285016", name: "The Town", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1285016/img" },
  { id: "tt1375666", name: "Drive", year: 2011, poster: "https://images.metahub.space/poster/medium/tt0780504/img" },
  { id: "tt1340800", name: "The Place Beyond the Pines", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1817771/img" },
  { id: "tt2267998", name: "Gone Girl", year: 2014, poster: "https://images.metahub.space/poster/medium/tt2267998/img" },
  { id: "tt3741834", name: "Sicario", year: 2015, poster: "https://images.metahub.space/poster/medium/tt3741834/img" },
  { id: "tt0101414", name: "The Silence of the Lambs", year: 1991, poster: "https://images.metahub.space/poster/medium/tt0101414/img" },
  { id: "tt4080016", name: "Hell or High Water", year: 2016, poster: "https://images.metahub.space/poster/medium/tt4080016/img" }
];

const western = [
  { id: "tt0060196", name: "The Good, the Bad and the Ugly", year: 1966, poster: "https://images.metahub.space/poster/medium/tt0060196/img" },
  { id: "tt0064116", name: "Once Upon a Time in the West", year: 1968, poster: "https://images.metahub.space/poster/medium/tt0064116/img" },
  { id: "tt0047296", name: "Shane", year: 1953, poster: "https://images.metahub.space/poster/medium/tt0046303/img" },
  { id: "tt0054047", name: "The Magnificent Seven", year: 1960, poster: "https://images.metahub.space/poster/medium/tt0054047/img" },
  { id: "tt0057115", name: "How the West Was Won", year: 1962, poster: "https://images.metahub.space/poster/medium/tt0056085/img" },
  { id: "tt0112573", name: "Braveheart", year: 1995, poster: "https://images.metahub.space/poster/medium/tt0112573/img" },
  { id: "tt0059578", name: "For a Few Dollars More", year: 1965, poster: "https://images.metahub.space/poster/medium/tt0059578/img" },
  { id: "tt0077631", name: "Butch Cassidy and the Sundance Kid", year: 1969, poster: "https://images.metahub.space/poster/medium/tt0064115/img" },
  { id: "tt0758758", name: "3:10 to Yuma", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0381849/img" },
  { id: "tt0361748", name: "True Grit", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1403865/img" },
  { id: "tt0477348", name: "No Country for Old Men", year: 2007, poster: "https://images.metahub.space/poster/medium/tt0477348/img" },
  { id: "tt4080016", name: "Hell or High Water", year: 2016, poster: "https://images.metahub.space/poster/medium/tt4080016/img" },
  { id: "tt3460252", name: "The Hateful Eight", year: 2015, poster: "https://images.metahub.space/poster/medium/tt3460252/img" },
  { id: "tt0266697", name: "Django Unchained", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1853728/img" },
  { id: "tt1375666", name: "Hostiles", year: 2017, poster: "https://images.metahub.space/poster/medium/tt5478478/img" },
  { id: "tt0112641", name: "Tombstone", year: 1993, poster: "https://images.metahub.space/poster/medium/tt0108358/img" },
  { id: "tt0093779", name: "Silverado", year: 1985, poster: "https://images.metahub.space/poster/medium/tt0090022/img" },
  { id: "tt0060522", name: "The Wild Bunch", year: 1969, poster: "https://images.metahub.space/poster/medium/tt0065214/img" },
  { id: "tt0053221", name: "Rio Bravo", year: 1959, poster: "https://images.metahub.space/poster/medium/tt0053221/img" },
  { id: "tt0045061", name: "High Noon", year: 1952, poster: "https://images.metahub.space/poster/medium/tt0044706/img" }
];

const superhero = [
  { id: "tt0371746", name: "Iron Man", year: 2008, poster: "https://images.metahub.space/poster/medium/tt0371746/img" },
  { id: "tt0458339", name: "Captain America: The First Avenger", year: 2011, poster: "https://images.metahub.space/poster/medium/tt0458339/img" },
  { id: "tt0848228", name: "The Avengers", year: 2012, poster: "https://images.metahub.space/poster/medium/tt0848228/img" },
  { id: "tt1843866", name: "Captain America: The Winter Soldier", year: 2014, poster: "https://images.metahub.space/poster/medium/tt1843866/img" },
  { id: "tt2395427", name: "Avengers: Age of Ultron", year: 2015, poster: "https://images.metahub.space/poster/medium/tt2395427/img" },
  { id: "tt3498820", name: "Captain America: Civil War", year: 2016, poster: "https://images.metahub.space/poster/medium/tt3498820/img" },
  { id: "tt3501632", name: "Thor: Ragnarok", year: 2017, poster: "https://images.metahub.space/poster/medium/tt3501632/img" },
  { id: "tt4154756", name: "Avengers: Infinity War", year: 2018, poster: "https://images.metahub.space/poster/medium/tt4154756/img" },
  { id: "tt4154796", name: "Avengers: Endgame", year: 2019, poster: "https://images.metahub.space/poster/medium/tt4154796/img" },
  { id: "tt1825683", name: "Black Panther", year: 2018, poster: "https://images.metahub.space/poster/medium/tt1825683/img" },
  { id: "tt1211837", name: "Doctor Strange", year: 2016, poster: "https://images.metahub.space/poster/medium/tt1211837/img" },
  { id: "tt0372784", name: "Batman Begins", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0372784/img" },
  { id: "tt0468569", name: "The Dark Knight", year: 2008, poster: "https://images.metahub.space/poster/medium/tt0468569/img" },
  { id: "tt1345836", name: "The Dark Knight Rises", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1345836/img" },
  { id: "tt0107290", name: "Superman", year: 1978, poster: "https://images.metahub.space/poster/medium/tt0078346/img" },
  { id: "tt0316654", name: "Spider-Man", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0145487/img" },
  { id: "tt0974015", name: "Wonder Woman", year: 2017, poster: "https://images.metahub.space/poster/medium/tt0451279/img" },
  { id: "tt1477834", name: "Aquaman", year: 2018, poster: "https://images.metahub.space/poster/medium/tt1477834/img" },
  { id: "tt6320628", name: "Spider-Man: Into the Spider-Verse", year: 2018, poster: "https://images.metahub.space/poster/medium/tt4633694/img" },
  { id: "tt2015381", name: "Guardians of the Galaxy", year: 2014, poster: "https://images.metahub.space/poster/medium/tt2015381/img" },
  { id: "tt3385516", name: "Ant-Man", year: 2015, poster: "https://images.metahub.space/poster/medium/tt0478970/img" },
  { id: "tt1219289", name: "Dredd", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1343727/img" },
  { id: "tt0289765", name: "X2: X-Men United", year: 2003, poster: "https://images.metahub.space/poster/medium/tt0290334/img" },
  { id: "tt0376994", name: "X-Men: Days of Future Past", year: 2014, poster: "https://images.metahub.space/poster/medium/tt1877832/img" },
  { id: "tt1431045", name: "Deadpool", year: 2016, poster: "https://images.metahub.space/poster/medium/tt1431045/img" }
];

const documentaries = [
  { id: "tt0418279", name: "March of the Penguins", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0428803/img" },
  { id: "tt0385661", name: "An Inconvenient Truth", year: 2006, poster: "https://images.metahub.space/poster/medium/tt0497116/img" },
  { id: "tt1798709", name: "Amy", year: 2015, poster: "https://images.metahub.space/poster/medium/tt2870648/img" },
  { id: "tt0185937", name: "Super Size Me", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0390521/img" },
  { id: "tt1787660", name: "The Act of Killing", year: 2012, poster: "https://images.metahub.space/poster/medium/tt2375605/img" },
  { id: "tt0361748", name: "Bowling for Columbine", year: 2002, poster: "https://images.metahub.space/poster/medium/tt0310793/img" },
  { id: "tt0266697", name: "Fahrenheit 9/11", year: 2004, poster: "https://images.metahub.space/poster/medium/tt0361596/img" },
  { id: "tt0112641", name: "Hoop Dreams", year: 1994, poster: "https://images.metahub.space/poster/medium/tt0110057/img" },
  { id: "tt1179891", name: "Exit Through the Gift Shop", year: 2010, poster: "https://images.metahub.space/poster/medium/tt1587707/img" },
  { id: "tt0478304", name: "Man on Wire", year: 2008, poster: "https://images.metahub.space/poster/medium/tt1155592/img" },
  { id: "tt1677720", name: "The Imposter", year: 2012, poster: "https://images.metahub.space/poster/medium/tt1966604/img" },
  { id: "tt2183034", name: "The Square", year: 2013, poster: "https://images.metahub.space/poster/medium/tt2486682/img" },
  { id: "tt3640424", name: "Citizenfour", year: 2014, poster: "https://images.metahub.space/poster/medium/tt4044364/img" },
  { id: "tt3741834", name: "13th", year: 2016, poster: "https://images.metahub.space/poster/medium/tt5895028/img" },
  { id: "tt5580390", name: "Won't You Be My Neighbor?", year: 2018, poster: "https://images.metahub.space/poster/medium/tt7681726/img" },
  { id: "tt1966604", name: "Free Solo", year: 2018, poster: "https://images.metahub.space/poster/medium/tt7775622/img" },
  { id: "tt6751668", name: "Three Identical Strangers", year: 2018, poster: "https://images.metahub.space/poster/medium/tt7155792/img" },
  { id: "tt10272386", name: "The Last Dance", year: 2020, poster: "https://images.metahub.space/poster/medium/tt8420184/img" },
  { id: "tt1160419", name: "Icarus", year: 2017, poster: "https://images.metahub.space/poster/medium/tt6334218/img" },
  { id: "tt1745960", name: "Into the Inferno", year: 2016, poster: "https://images.metahub.space/poster/medium/tt5405220/img" },
  { id: "tt0285403", name: "Grizzly Man", year: 2005, poster: "https://images.metahub.space/poster/medium/tt0437078/img" },
  { id: "tt0303461", name: "Planet Earth", year: 2006, poster: "https://images.metahub.space/poster/medium/tt0795176/img" },
  { id: "tt0367279", name: "Planet Earth II", year: 2016, poster: "https://images.metahub.space/poster/medium/tt5491994/img" },
  { id: "tt0108778", name: "Our Planet", year: 2019, poster: "https://images.metahub.space/poster/medium/tt8044286/img" },
  { id: "tt0460649", name: "Blackfish", year: 2013, poster: "https://images.metahub.space/poster/medium/tt2545118/img" }
];
...
builder.defineCatalogHandler(async ({ type, id, extra }) => {
  ...
  if (type === "movie" && id === "falcon-best-picture") {
    return { metas: bestPictureWinners.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Award-Winning Drama Series
  if (type === "series" && id === "falcon-award-drama") {
    return { metas: awardDramaSeries.slice(skip, skip + PAGE).map(m => buildMeta(m, "series")) };
  }

  // Sci-Fi & Space
  if (type === "movie" && id === "falcon-scifi") {
    return { metas: sciFi.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Action & Thriller
  if (type === "movie" && id === "falcon-action-thriller") {
    return { metas: actionThriller.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Animated & Family
  if (type === "movie" && id === "falcon-animated-family") {
    return { metas: animatedFamily.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Romance & Rom-Coms
  if (type === "movie" && id === "falcon-romance") {
    return { metas: romanceRomCom.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Crime & Gangster
  if (type === "movie" && id === "falcon-crime-gangster") {
    return { metas: crimeGangster.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Western
  if (type === "movie" && id === "falcon-western") {
    return { metas: western.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Superhero
  if (type === "movie" && id === "falcon-superhero") {
    return { metas: superhero.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }

  // Documentaries
  if (type === "movie" && id === "falcon-documentaries") {
    return { metas: documentaries.slice(skip, skip + PAGE).map(m => buildMeta(m, "movie")) };
  }
...
builder.defineMetaHandler(async ({ type, id }) => {
  ...
  if (id.startsWith("tt")) {
    const allMovies = [...classics80s90s, ...classics2000s, ...horror, ...bestPictureWinners, ...sciFi, ...actionThriller, ...animatedFamily, ...romanceRomCom, ...crimeGangster, ...western, ...superhero, ...documentaries];
    const allSeries = [...classicSeries, ...dramaSeries, ...comedySeries, ...awardDramaSeries];
